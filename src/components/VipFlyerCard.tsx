...
export const VipFlyerCard: React.FC<VipFlyerCardProps> = ({
  ...
  return (
    <div className="w-[220px] sm:w-[230px] h-[300px] rounded-2xl p-3 bg-[#101114] border-[1.5px] border-[#fe97de] select-none flex flex-col justify-between shadow-none">
      {/* Ilustración de Arte Retrowave / Pixel Art del Flyer */}
      <div className="relative w-full h-[135px] rounded-xl overflow-hidden bg-[#16181e] mb-2.5 flex items-center justify-center border border-neutral-800">
        {flyer.theme === 'dubai' && (
          <div className="w-full h-full relative flex flex-col items-center justify-center bg-gradient-to-b from-[#1b003a] via-[#090b1c] to-[#04040a] p-2">
            <div className="w-full h-full border border-purple-500/30 rounded flex flex-col items-center justify-between p-2">
              <div className="px-2.5 py-0.5 bg-[#101026] border border-[#00f3ff] rounded-sm">
              ...
              <div className="w-11 h-12 border-t-2 border-l-2 border-r-2 border-[#fe97de] bg-[#ff2a85]/20 flex items-center justify-center">
                <div className="w-1.5 h-1.5 bg-[#fe97de] rounded-full" />
              </div>
            </div>
          </div>
        )}
        ...
        {flyer.theme === 'indie' && (
          <div className="w-full h-full relative flex flex-col items-center justify-end bg-gradient-to-b from-[#0e1726] to-[#05080f] overflow-hidden p-2">
            <div className="absolute inset-0 flex justify-around opacity-40">
              <div className="w-7 h-full bg-gradient-to-b from-cyan-400 via-transparent to-transparent -rotate-12 transform origin-top" />
              <div className="w-7 h-full bg-gradient-to-b from-pink-500 via-transparent to-transparent rotate-6 transform origin-top" />
              <div className="w-7 h-full bg-gradient-to-b from-yellow-400 via-transparent to-transparent rotate-24 transform origin-top" />
            </div>
            <div className="relative z-10 flex items-end justify-center space-x-2.5 text-2xl mb-1">
              <span title="Guitarrista">🎸</span>
              <span title="Cantante">🎤</span>
              <span title="Bajo">⚡</span>
            </div>
            <div className="w-full h-1.5 bg-purple-950 rounded-sm" />
          </div>
        )}
      ...
      <div className="flex-1 flex flex-col justify-between">
        <div>
          <h4 className="font-display text-white text-[15px] font-bold tracking-tight uppercase line-clamp-1">
